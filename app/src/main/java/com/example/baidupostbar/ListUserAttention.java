...
public class ListUserAttention extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_user_attention);
...
//                holder.setTextColor(R.id.tv, Color.BLACK);
            ...
            public void onItemSwipeMoving(Canvas canvas, RecyclerView.ViewHolder viewHolder, float dX, float dY, boolean isCurrentlyActive) {
                canvas.drawColor(ContextCompat.getColor(ListUserAttention.this, R.color.white));
...
//                    list_url.add(map);
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (e instanceof SocketTimeoutException){
                                Toast.makeText(ListUserAttention.this,"连接超时",Toast.LENGTH_SHORT).show();
                            }
                            if (e instanceof ConnectException){
                                Toast.makeText(ListUserAttention.this,"连接异常",Toast.LENGTH_SHORT).show();
                            }

                            if (e instanceof ProtocolException) {
                                Toast.makeText(ListUserAttention.this,"未知异常，请稍后再试",Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
    ...
    private void showResponse(final String response){
        ...
        try {
            ...
            msgAttentionList.addAll(t);
            //if (userCommentList != null)
            //{
            Log.d("关注消息列表",msgAttentionList.toString());
            //}
